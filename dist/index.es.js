...
var endpointToday = "https://api.openweathermap.org/data/2.5/onecall?exclude=minutely,daily";
var ReactWeather = function (_a) {
    var lat = _a.lat, lon = _a.lon, city = _a.city, apiKey = _a.apiKey, _b = _a.lang, lang = _b === void 0 ? "en" : _b, _c = _a.unit, unit = _c === void 0 ? "metric" : _c, loadingComponent = _a.loadingComponent;
    ...
    useEffect(function () {
        ...
        fetch(String(url))
            ...
            .then(function (_a) {
            var current = _a.current, hourly = _a.hourly;
            if (!current)
                return;
            setData({
    ...
    if (!data)
        return loadingComponent || React.createElement("div", null, "Loading...");
    var todayIcon = getIcon(data.icon);
    var units = getUnits(unit);
    var langs = getLangs(lang);
    return (React.createElement("div", { className: "rw-main" },
        React.createElement("div", { className: "rw-box" },
            React.createElement("div", { className: "rw-box__top" },
                React.createElement("div", null,
                    React.createElement("p", null, langs.todayWeather),
                    React.createElement("div", { className: "current-temp" },
                        React.createElement("i", { className: "wicon wi " + todayIcon }),
                        React.createElement("span", { className: "current-temp__temp" },
                            data.temperature.current,
                            " ",
                            units.temp),
                        React.createElement("span", null, data.description))),
                React.createElement("div", { className: "current-dt" },
                    city,
                    React.createElement("br", null),
                    data.date)),
            React.createElement("div", { className: "rw-box__bottom" },
                React.createElement("div", null,
                    langs.wind,
                    React.createElement("br", null),
                    data.wind,
